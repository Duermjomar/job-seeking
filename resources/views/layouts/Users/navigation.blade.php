            ...
            <div class="navbar-right">
                ...
                <div class="notification-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu"
                        ...
                        <div class="notification-dropdown-header">
                            ...
                            @if (auth()->user()->unreadNotificationsCount() > 0)
                                <form action="{{ route('users.notifications.mark-all-read') }}" method="POST"
                                    class="d-inline">
                                    @csrf
                        ...
                        <div class="notification-dropdown-body">
                            @forelse(auth()->user()->notifications()->take(5)->get() as $notification)
                                <a href="{{ route('users.notifications.mark-read', $notification->id) }}"
                        ...
                        <div class="notification-dropdown-footer">
                            <a href="{{ route('users.notifications.index') }}" class="btn-view-all">
                ...
                <div class="dropdown user-dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-custom dropdown-menu-end" aria-labelledby="userDropdown">
                        ...
                        {{-- Profile & Logout --}}
                        <li>
                            <a class="dropdown-item-custom" href="{{ route('users.profile.edit') }}">
    ...
    <div class="offcanvas-body">
        ...
        <div class="mobile-nav-links">
            ...
            <a href="{{ route('users.feedback.create') }}"
                class="mobile-nav-link {{ request()->routeIs('users.feedback.create') ? 'active' : '' }}">
                <i class="bi bi-chat-dots"></i>
                <span>Send Feedback</span>
            </a>
            <a href="{{ route('users.myfeedback') }}"
                class="mobile-nav-link {{ request()->routeIs('users.myfeedback') ? 'active' : '' }}">
        ...
        <div class="mobile-actions">
            <a href="{{ route('users.profile.edit') }}" class="mobile-action-btn">
...
<script>
    (function() {
        ...
        const NOTIFICATION_COUNT_URL = '{{ route('users.notifications.unread-count') }}';
