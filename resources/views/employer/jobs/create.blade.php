            ...
            <div class="col-lg-8">
                ...
                <div class="form-card">
                    <div class="card-body p-4">
                        <form action="{{ route('employer.jobs.store') }}" 
                              method="POST" 
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-custom">
                                        <label class="form-label-custom">
                                            <i class="bi bi-cash-coin me-2"></i>Salary <span class="optional-badge">Optional</span>
                                        </label>
                                        <input type="number"
                                               name="salary"
                                               class="form-control-custom"
...
<style>
    ...
    * { font-family: 'Outfit', sans-serif; }
    ...
    .job-post-wrapper { min-height: 100vh; }
    ...
    /* Form Card */
    .form-card {
        background: white; border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);
    ...
    .form-label-custom i { color: var(--primary-color); }
    .optional-badge {
        background: var(--input-bg); color: var(--text-muted); font-size: 0.75rem;
        padding: 0.2rem 0.5rem; border-radius: 6px; margin-left: 0.5rem; font-weight: 500;
    }

    .form-control-custom, .form-select-custom {
        width: 100%; padding: 0.75rem 1rem; border: 2px solid var(--border-color);
        border-radius: 10px; background: var(--input-bg); color: var(--text-dark);
    ...
    .file-upload-label {
        ...
        border: 2px dashed var(--border-color); border-radius: 12px; background: var(--input-bg);
        cursor: pointer; transition: all 0.3s ease; color: var(--text-muted); font-weight: 500;
    }
    .file-upload-label:hover {
        border-color: var(--primary-color); background: linear-gradient(135deg, #FFF5F2, #FFE8E0);
        color: var(--primary-color);
    }
    .file-upload-label i { font-size: 1.5rem; }

    .selected-files-container { display: none; }
    .selected-files-container.has-files { display: block; }

    .file-item {
        display: flex; align-items: center; justify-content: space-between;
        padding: 0.75rem 1rem; background: linear-gradient(135deg, #F7F9FC, #FFF);
        border: 2px solid var(--border-color); border-radius: 10px;
        margin-bottom: 0.5rem; transition: all 0.3s ease;
    }
    .file-item:hover { border-color: var(--primary-color); background: linear-gradient(135deg, #FFF5F2, #FFF); }

    .file-item-info { display: flex; align-items: center; gap: 0.75rem; flex: 1; }
    .file-item-icon {
    ...
    .file-item-name { font-weight: 600; color: var(--text-dark); font-size: 0.9rem; margin-bottom: 0.2rem; }
    .file-item-size { font-size: 0.75rem; color: var(--text-muted); }
    .file-item-remove {
        background: transparent; border: none; color: #FF6B6B; font-size: 1.25rem;
        cursor: pointer; padding: 0.5rem; border-radius: 6px; transition: all 0.3s ease;
    }
    .file-item-remove:hover { background: rgba(255,107,107,0.1); }

    .form-hint { color: var(--text-muted); font-size: 0.85rem; margin-top: 0.5rem; display: block; }
    ...
    .btn-submit:hover {
        transform: translateY(-2px); box-shadow: 0 8px 24px rgba(255,107,53,0.4);
        background: linear-gradient(135deg, var(--primary-dark), var(--primary-color));
    }

    .btn-cancel {
        background: white; color: var(--text-dark); border: 2px solid var(--border-color);
        padding: 1rem 2rem; border-radius: 12px; font-weight: 700; font-size: 1.05rem;
        text-decoration: none; display: flex; align-items: center; justify-content: center;
        transition: all 0.3s ease;
    }
    .btn-cancel:hover {
        background: var(--text-muted); color: white; border-color: var(--text-muted);
    }
    ...
    /* Custom Scrollbar */
    textarea.form-control-custom::-webkit-scrollbar { width: 8px; }
    textarea.form-control-custom::-webkit-scrollbar-track { background: var(--input-bg); border-radius: 10px; }
    textarea.form-control-custom::-webkit-scrollbar-thumb { background: var(--border-color); border-radius: 10px; }
    textarea.form-control-custom::-webkit-scrollbar-thumb:hover { background: var(--primary-color); }
</style>
