                ...
                <div class="col-lg-8">
                    ...
                    <div class="feedback-card">
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('employer.feedback.store') }}" method="POST" class="feedback-form">
                                @csrf
                                ...
                                <div class="form-group-custom mb-4">
                                    ...
                                    <textarea name="comm" class="form-control-custom" rows="6"
                                        placeholder="Share your thoughts, suggestions, or experiences with us..." required></textarea>
