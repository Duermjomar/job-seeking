                    ...
                    <div class="page-header mb-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <form action="{{ route('users.notifications.clear-read') }}" method="POST"
                                ...
                                <div class="notification-content">
                                    ...
                                    <div class="notification-body">
                                        ...
                                        @if ($notification->action_url)
                                            <form action="{{ route('users.notifications.mark-read', $notification->id) }}"
                                                method="POST" style="display:inline;">
                                                @csrf
                                                <button type="submit" class="btn-view-action">
                                    ...
                                    <div class="notification-actions">
                                        ...
                                        {{-- Delete button --}}
                                        <form action="{{ route('users.notifications.destroy', $notification->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
